...
<head>
  <meta charset="UTF-8" />
	...
	<title>View All Users || Admin UG Store</title>
</head>
					...
					<div class="col-sm-12">
                        ...
                        <?php if(!empty($users)){ foreach($users as $usrow){ ?>
                            ...
                            <td><?php echo $usrow->email; ?></td>
														<td>
															<img style="height:50px; width:50px;" src="<?php echo base_url('uploads/original.jpg'); ?>"
                              alt="<?php echo $usrow->firstname; ?> <?php echo $usrow->lastname; ?>" width="80">
														</td>
														<td><?php echo $usrow->telephone; ?></td>
                            <td><?php echo $usrow->address; ?></td>
														<td><?php echo $usrow->postcode; ?></td>
                            <td><?php echo $usrow->town; ?></td>
                            <td><?php echo $usrow->county; ?></td>
