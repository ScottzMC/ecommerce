...
<html lang="en">
	<head>
		...
		<title>Edit My Website Banners || Admin Beauty Shop</title>
	</head>
...
<div class="panel panel-default card-view">
  ...
  <script>
		function delete_banner(id){
			...
			$.post('<?php echo base_url('admin/edit/banner/delete_banner'); ?>', {"banner_id": banner_id}, function(data){
				location.reload();
				$('#cte').html(data)
				});
			}
    ...
    <div class="panel-body">
      ...
      <div class="tags-default mt-40">
				<?php if(!empty($banner)){ foreach($banner as $ban){ ?>
					<br>
					<img style="width: 170px; height: 120px;" src="<?php echo base_url('uploads/banners/'.$ban->image); ?>" alt="<?php echo $ban->image; ?>">
...
<div class="panel panel-default card-view">
  ...
  <form action="<?php echo base_url('admin/edit/banner/add_banner'); ?>" method="post" enctype="multipart/form-data" role="form">
	<div class="panel-wrapper collapse in">
    <div class="panel-body">
      <p class="text-muted">Add <code>Banners on the website from here.</code> eg - Slider 1.</p>
          ...
          <div class="form-group">
            <label class="control-label mb-10">Banners Type</label>
            <select class="form-control" data-placeholder="Choose a Type" id="banner_type" name="banner_type">
    ...
    <div class="panel-body">
      ...
      <div class="tags-default mt-40">
				<?php foreach($banner as $ban){ ?>
					<br>
					<img style="width: 170px; height: 120px;" src="<?php echo base_url('uploads/banners/'.$ban->image); ?>">
					<br>
					<h6><?php echo str_replace('-', ' ', $ban->type); ?></h6>
					<br>
					<p class="text-muted">Edit <code>Where the Slider would show on the Website by Type.</code> eg - Fashion.</p>
					<br>
          <a href="<?php echo site_url('admin/edit/banner/edit_banner/'.$ban->id); ?>" class="btn btn-danger btn-icon left-icon mr-10">
            <i class="fa fa-check"></i>
          </a>
          <br>
        <?php } ?>
