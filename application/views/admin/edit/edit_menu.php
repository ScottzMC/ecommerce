...
<html lang="en">
    ...
    <?php foreach($edit_menu as $edt_menu){} ?>
		<title>Edit <?php echo str_replace('-', ' ', $edt_menu->type); ?> Menu || Admin Beauty Shop</title>
	</head>
...
<h5 class="txt-light">Dasboard Edit <?php echo $edt_menu->type; ?> Menu</h5>
</div>
<!-- Breadcrumb -->
...
<ol class="breadcrumb">
  ...
  <li class="active"><span>Edit <?php echo str_replace('-', ' ', $edt_menu->type); ?> Menu</span></li>
</ol>
</div>
<!-- /Breadcrumb -->
</div>
...
<div class="panel panel-default card-view">
  <div class="panel-heading">
    ...
    <div class="panel-body">
      <form action="<?php echo base_url('admin/edit/menu/edit_menu/'.$edt_menu->id); ?>" method="post" role="form">
      <p class="text-muted">Add <code>Menu of the website.</code></p>
          <br>
          <label class="control-label mb-10">Add Menu Type</label><br>
          <input type="text" name="type" style="color: black;" value="<?php echo str_replace('-', ' ', $edt_menu->type); ?>"/><br>
          <span><?php echo form_error('type'); ?></span>
          <br><p class="text-muted">Add <code> Menu Type of the Website.</code>e.g - Cosmetics</p>
          <br><br>
