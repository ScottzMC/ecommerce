...
<html lang="en">
    ...
    <?php foreach($edit_about_content as $edt_abt){} ?>
		<title>Edit <?php echo str_replace('-', ' ', $edt_abt->title); ?> About Content || Admin Tiger Phenix Online Store</title>
	</head>
...
<h5 class="txt-light">Dasboard Edit <?php echo $edt_abt->title; ?> About Content</h5>
</div>
<!-- Breadcrumb -->
...
<ol class="breadcrumb">
  ...
  <li class="active"><span>Edit <?php echo str_replace('-', ' ', $edt_abt->title); ?> About Content</span></li>
</ol>
</div>
<!-- /Breadcrumb -->
</div>
...
<div class="panel panel-default card-view">
  <div class="panel-heading">
    ...
    <div class="panel-body">
      <form action="<?php echo base_url('admin/edit/about/edit_about/'.$edt_abt->id); ?>" method="post" role="form">
      <p class="text-muted">Add <code>About Contents of the website from here on the Footer.</code></p>
          ...
          <input type="text" name="title" style="color: black;" value="<?php echo str_replace('-', ' ', $edt_abt->title); ?>"/><br>
          ...
          <br><br>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<textarea id="editorabout" class="summernote" rows="7" cols="15" name="body"><?php echo $edt_abt->body; ?></textarea><br>
