...
<html lang="en">
    ...
    <?php foreach($edit_product as $edt_prod){} ?>
		<title>Edit <?php echo $edt_prod->title; ?> || Admin UG Store</title>
	</head>
              ...
              <div class="container-fluid">
  				...
  				<div class="row heading-bg  bg-pink">
  					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
  					  <h5 class="txt-light">Edit <?php echo $edt_prod->title; ?> Product</h5>
  					</div>
  					<!-- Breadcrumb -->
                ...
                <li><a href="<?php echo site_url('admin/dashboard'); ?>">Dashboard</a></li>
  							...
  							<li class="active"><span>Edit <?php echo $edt_prod->title; ?> Product</span></li>
  					  </ol>
  					</div>
  					<!-- /Breadcrumb -->
  				</div>
							...
							<div class="panel panel-default card-view">
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form action="<?php echo base_url('admin/product/edit_product/edit/'.$edt_prod->id); ?>" method="POST" enctype="multipart/form-data" name="formSubmit" onsubmit="return CheckLength()" role="form">
                        ...
                        <div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" id="title" name="title" class="form-control" placeholder="Rounded Chair" value="<?php echo $edt_prod->title; ?>">
                              ...
                              <option value="White">White</option>
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<select class="form-control" data-placeholder="Choose a Type" name="brand">
															<option>Select</option>
															<?php
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<select class="form-control" data-placeholder="Choose a Type" name="size">
															<option>Select</option>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="input-group">
																...
																<input type="text" name="price" class="form-control" id="exampleInputuname" placeholder="1000" value="<?php echo $edt_prod->price; ?>">
                          ...
                          <br><br>
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															<textarea id="editordata" class="summernote" rows="7" cols="15" name="description">
                                <?php echo $edt_prod->description; ?>
                              </textarea>
