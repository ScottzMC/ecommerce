...
<head>
	...
	<title>View All Orders || Admin UG Store</title>
...
<body>
    ...
    $.post('<?php echo base_url('admin/[product/view_order/cancel_order'); ?>', {"del_id": del_id}, function(data){
      location.reload();
      $('#cti').html(data)
      });
    }
    ...
    <p id='cti'></p>
              ...
              <div class="panel-wrapper collapse in">
                          ...
                          <?php if(!empty($orders)){ foreach($orders as $odow){ ?>
                            ...
                            <td>
                              <a class="btn btn-primary btn-icon-anim btn-square" title="View Invoice" href="<?php echo site_url('admin/dashboard/product/view_invoice/'.$odow->order_id); ?>">
