...
<head>
    ...
    <title><?php echo $typ->type; ?> Categories || UG Store</title>
        ...
        <div class="breadcrumb-area">
            <div class="container">
                <div class="breadcrumb-content">
                    <h2><?php echo $typ->type; ?> Categories</h2>
                    <ul>
                        <li><a href="<?php echo site_url('home'); ?>">Home</a></li>
                        <li class="active"><?php echo $typ->type; ?></li>
                    </ul>
                </div>
            </div>
        </div>
                                  ...
                                  foreach($query as $qry){ ?>
                                    <li>
                                      ...
                                      <?php if(!empty($sql->total_brand)){ ?>
                                        <a href="<?php echo site_url('other/brand_type/'.strtolower($typ->type).'/'.strtolower($qry->brand)); ?>">
                                ...
                                <ul class="sidebar-checkbox_list">
                                  ...
                                  foreach($query as $qry){ ?>
                                    <li>
                                      ...
                                      <a href="<?php echo site_url('other/color_type/'.strtolower($typ->type).'/'.strtolower($qry->color)); ?>">
                                  ...
                                  foreach($query as $qry){ ?>
                                    <li>
                                      ...
                                      <?php if(!empty($sql->total_size)){ ?>
                                        <a href="<?php echo site_url('other/size_type/'.strtolower($typ->type).'/'.strtolower($qry->size)); ?>">
                    ...
                    <div class="col-xl-9 col-lg-8 order-1 order-lg-2">
                        <div class="shop-toolbar">
                            ...
                            <div class="product-item-selection_area">
                              <form action="<?php echo base_url('sort/type/'.strtolower($typ->type)); ?>" method="post">
                        ...
                        <div class="shop-product-wrap grid gridview-3 row">
                          <!-- Loop -->
                          <?php if(!empty($type)){ foreach($type as $typ){ ?>
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="product-item">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="<?php echo site_url('product/detail/'.strtolower($typ->product_code)); ?>">
                                                <img height="250" class="primary-img" src="<?php echo base_url('uploads/products/'.$typ->image); ?>" alt="<?php echo $typ->title; ?>">
                                            </a>
                                              ...
                                              <ul>
                                                ...
                                                if(!empty($email)){
                                                  ...
                                                  if($membership == 'Premium Member'){
                                                    $price = $typ->price - ($typ->price * 20/100);
                                                  }else if($membership == 'Elite Member'){
                                                    $price = $typ->price - ($typ->price * 30/100);
                                                ...
                                                <form action="<?php echo base_url('shopping/wishlist/add'); ?>" method="post">
                                                  ...
                                                  <input type="hidden" name="product_code" value="<?php echo $typ->product_code; ?>">
                                                  <input type="hidden" name="title" value="<?php echo $typ->title; ?>">
                                                  <input type="hidden" name="type" value="<?php echo $typ->type; ?>">
                                                  <input type="hidden" name="category" value="<?php echo $typ->category; ?>">
                                                  ...
                                                  <?php } ?>
                                                  <input type="hidden" name="image" value="<?php echo $typ->image; ?>">
                                                  <li>
                                        ...
                                        <div class="product-content">
                                            <div class="product-desc_info">
                                                <h3 class="product-name"><a href="<?php echo site_url('product/detail/'.strtolower($typ->product_code)); ?>"><?php echo $typ->title; ?></a></h3>
                                                <div class="price-box">
                                                  <?php if(!empty($email) && !empty($membership) == 'Normal' || !empty($membership) == 'Premium Member' || !empty($membership) == 'Elite Member'){ ?>
                                                    <span class="new-price">&pound;<?php echo $price; ?></span>
                                                  <?php }else{ ?>
                                                    <span class="new-price">&pound;<?php echo $typ->price; ?></span>
                                                  <?php } ?>
