...
<head>
    ...
    <title>Search (<?php echo $search_query; ?>) Result || UG Store</title>
                    ...
                    <div class="col-xl-9 col-lg-8 order-1 order-lg-2">
                        <div class="shop-toolbar">
                            ...
                            <div class="product-page_count">
                                <p>Showing (<?php echo $search_query; ?>) Result</p>
                            </div>
                        </div>
                                ...
                                <div class="product-item">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="<?php echo site_url('product/detail/'.strtolower($sea->product_code)); ?>">
                                                <img height="220" class="primary-img" src="<?php echo base_url('uploads/products/'.$sea->image1); ?>" alt="<?php echo $sea->title; ?>">
                                            </a>
                                            <div class="add-actions">
                                                <ul>
                                                  ...
                                                  <form action="<?php echo base_url('shopping/wishlist/add'); ?>" method="post">
                                                    ...
                                                    <input type="hidden" name="product_code" value="<?php echo $sea->product_code; ?>">
                                                    <input type="hidden" name="title" value="<?php echo $sea->title; ?>">
                                                    <input type="hidden" name="type" value="<?php echo $sea->type; ?>">
                                        ...
                                        <div class="product-content">
                                            <div class="product-desc_info">
                                                <h3 class="product-name"><a href="<?php echo site_url('product/detail/'.strtolower($sea->product_code)); ?>"><?php echo $sea->title; ?></a></h3>
                                                <div class="price-box">
                                                    <span class="new-price">&pound;<?php echo $sea->price; ?></span>
