...
<head>
    ...
    <title><?php echo $oth->type; ?> Categories || UG Store</title>
        ...
        <div class="breadcrumb-area">
            <div class="container">
                <div class="breadcrumb-content">
                    <h2><?php echo $oth->type; ?> Categories</h2>
                    <ul>
                        <li><a href="<?php echo site_url('home'); ?>">Home</a></li>
                        <li class="active"><?php echo $oth->type; ?></li>
                    </ul>
                </div>
            </div>
        </div>
                                  ...
                                  foreach($query as $qry){ ?>
                                    <li>
                                      ...
                                      <?php if(!empty($sql->total_brand)){ ?>
                                        <a href="<?php echo site_url('other/brand_type/'.strtolower($oth->type).'/'.strtolower($qry->brand)); ?>">
                                ...
                                <ul class="sidebar-checkbox_list">
                                  ...
                                  foreach($query as $qry){ ?>
                                    <li>
                                      ...
                                      <a href="<?php echo site_url('other/color_type/'.strtolower($oth->type).'/'.strtolower($qry->color)); ?>">
                                  ...
                                  foreach($query as $qry){ ?>
                                    <li>
                                      ...
                                      <?php if(!empty($sql->total_size)){ ?>
                                        <a href="<?php echo site_url('other/size_type/'.strtolower($oth->type).'/'.strtolower($qry->size)); ?>">
                    ...
                    <div class="col-xl-9 col-lg-8 order-1 order-lg-2">
                        <div class="shop-toolbar">
                            ...
                            <div class="product-item-selection_area">
                              <form action="<?php echo base_url('sort/type/'.strtolower($oth->type)); ?>" method="post">
                                ...
                                <div class="product-item">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="<?php echo site_url('product/detail/'.strtolower($oth->product_code)); ?>">
                                                <img height="250" class="primary-img" src="<?php echo base_url('uploads/products/'.$oth->image); ?>" alt="<?php echo $oth->title; ?>">
                                            </a>
                                                ...
                                                <ul>
                                                  ...
                                                  if(!empty($email)){
                                                    ...
                                                    if($membership == 'Premium Member'){
                                                      $price = $oth->price - ($oth->price * 20/100);
                                                    }else if($membership == 'Elite Member'){
                                                      $price = $oth->price - ($oth->price * 30/100);
                                                  ...
                                                  <form action="<?php echo base_url('shopping/wishlist/add'); ?>" method="post">
                                                    <input type="hidden" name="id" value="<?php echo $oth->id; ?>">
                                                    <input type="hidden" name="email" value="<?php echo $this->session->userdata('uemail'); ?>">
                                                    <input type="hidden" name="product_code" value="<?php echo $oth->product_code; ?>">
                                                    <input type="hidden" name="title" value="<?php echo $oth->title; ?>">
                                                    <input type="hidden" name="type" value="<?php echo $oth->type; ?>">
                                                    <input type="hidden" name="category" value="<?php echo $oth->category; ?>">
                                                    <?php if(!empty($email) && !empty($membership) == 'Normal' || !empty($membership) == 'Premium Member' || !empty($membership) == 'Elite Member'){ ?>
                                                      <input type="hidden" name="price" value="<?php echo $price; ?>">
                                                    <?php }else{ ?>
                                                      <input type="hidden" name="price" value="<?php echo $oth->price; ?>">
                                                    <?php } ?>
                                                    <input type="hidden" name="image" value="<?php echo $oth->image; ?>">
                                                    <li>
                                        ...
                                        <div class="product-content">
                                            <div class="product-desc_info">
                                                <h3 class="product-name"><a href="<?php echo site_url('product/detail/'.strtolower($oth->product_code)); ?>"><?php echo $oth->title; ?></a></h3>
                                                <div class="price-box">
                                                  <?php if(!empty($email) && !empty($membership) == 'Normal' || !empty($membership) == 'Premium Member' || !empty($membership) == 'Elite Member'){ ?>
                                                    <span class="new-price">&pound;<?php echo $price; ?></span>
                                                  <?php }else{ ?>
                                                    <span class="new-price">&pound;<?php echo $oth->price; ?></span>
                                                  <?php } ?>
