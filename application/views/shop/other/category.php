...
<head>
    ...
    <title><?php echo $oth->category; ?> Categories || UG Store</title>
        ...
        <div class="breadcrumb-area">
            <div class="container">
                <div class="breadcrumb-content">
                    <h2><?php echo $oth->category; ?> Categories</h2>
                    <ul>
                      <li><a href="<?php echo site_url('home'); ?>">Home</a></li>
                      <li><a href="<?php echo site_url('product/type/'.strtolower($oth->type)); ?>"><?php echo $oth->type; ?></a></li>
                      <li class="active"><?php echo $oth->category; ?></li>
                    </ul>
                </div>
            </div>
        </div>
                                ...
                                <ul class="sidebar-checkbox_list">
                                  ...
                                  foreach($query as $qry){ ?>
                                    <li>
                                      ...
                                      AND product.type = '$oth->type' AND product.category = '$oth->category' ")->result();
                                      foreach($sequel as $sql){
                                      }
                                      ?>
                                      <?php if(!empty($sql->total)){ ?>
                                      <a href="<?php echo site_url('other/brand_category/'.strtolower($oth->type).'/'.strtolower($oth->category).'/'.strtolower($qry->brand)); ?>">
                                ...
                                <ul class="sidebar-checkbox_list">
                                  ...
                                  foreach($query as $qry){ ?>
                                    <li>
                                      ...
                                      ?>
                                      <?php if(!empty($sql->total)){ ?>
                                      <a href="<?php echo site_url('other/color_category/'.strtolower($oth->type).'/'.strtolower($oth->category).'/'.strtolower($qry->color)); ?>">
                                ...
                                <ul class="sidebar-checkbox_list">
                                  ...
                                  foreach($query as $qry){ ?>
                                    <li>
                                      ...
                                      ?>
                                      <?php if(!empty($sql->total)){ ?>
                                      <a href="<?php echo site_url('other/size_category/'.strtolower($oth->type).'/'.strtolower($oth->category).'/'.strtolower($qry->size)); ?>">
                    ...
                    <div class="col-xl-9 col-lg-8 order-1 order-lg-2">
                        <div class="shop-toolbar">
                            ...
                            <div class="product-item-selection_area">
                              <form action="<?php echo base_url('sort/category/'.strtolower($oth->type).'/'.strtolower($oth->category)); ?>" method="post">
