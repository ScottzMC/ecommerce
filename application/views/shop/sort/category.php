...
<head>
    ...
    <title>Sort <?php echo $srt->category; ?> Categories || UG Store</title>
                                ...
                                <ul class="sidebar-checkbox_list">
                                  ...
                                  foreach($query as $qry){ ?>
                                    <li>
                                      ...
                                      AND product.type = '$srt->type' AND product.category = '$srt->category' ")->result();
                                      foreach($sequel as $sql){
                                      }
                                      ?>
                                      <?php if(!empty($sql->total)){ ?>
                                      <a href="<?php echo site_url('other/brand_category/'.strtolower($srt->type).'/'.strtolower($srt->category).'/'.strtolower($qry->brand)); ?>">
                                ...
                                <ul class="sidebar-checkbox_list">
                                  ...
                                  foreach($query as $qry){ ?>
                                    <li>
                                      ...
                                      ?>
                                      <?php if(!empty($sql->total)){ ?>
                                      <a href="<?php echo site_url('other/color_category/'.strtolower($srt->type).'/'.strtolower($srt->category).'/'.strtolower($qry->color)); ?>">
                                ...
                                <ul class="sidebar-checkbox_list">
                                  ...
                                  foreach($query as $qry){ ?>
                                    <li>
                                      ...
                                      ?>
                                      <?php if(!empty($sql->total)){ ?>
                                      <a href="<?php echo site_url('other/size_category/'.strtolower($srt->type).'/'.strtolower($srt->category).'/'.strtolower($qry->size)); ?>">
                    ...
                    <div class="col-xl-9 col-lg-8 order-1 order-lg-2">
                        <div class="shop-toolbar">
                            ...
                            <div class="product-item-selection_area">
                              <form action="<?php echo base_url('sort/category/'.strtolower($srt->type).'/'.strtolower($srt->category)); ?>" method="post">
